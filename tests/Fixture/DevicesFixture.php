...
class DevicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'serial' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'devices_id1_idx' => ['type' => 'index', 'columns' => ['member_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => 1,
            'member_id' => '0b97e662-04e5-4c14-ae86-51182caa2c31',
